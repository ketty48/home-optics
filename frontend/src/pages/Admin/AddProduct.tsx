...
import { Loader, Plus, Upload, Trash2, Star, ArrowLeft } from 'lucide-react';
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="bg-white rounded-xl shadow-sm p-5 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Original Price (Fr) <span className="text-gray-400 font-normal">optional</span></label>
